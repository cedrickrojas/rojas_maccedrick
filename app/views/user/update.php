  ...
  <div class="form-container">
    ...
    <form method="post" action="<?= site_url('user/update/'.$user['id']) ?>">
      <div class="form-group">
        ...
        <input type="text" name="username" id="username" value="<?= html_escape($user['username']) ?>" required autocomplete="username">
      </div>

      <div class="form-group">
        <label for="email">Email Address</label>
        <input type="email" name="email" id="email" value="<?= html_escape($user['email']) ?>" required autocomplete="email">
      </div>
